...
def main(args):
    ...
    if args.task_mode is "interactive":
        run_pipeline(path_dataset = path_dataset)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--task_mode", type=str, required=False, help="Path to JSON file with tasks")
